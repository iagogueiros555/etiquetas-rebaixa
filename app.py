...
def desenhar_etiqueta(c, item, x_base, y_base, col_w, row_h, scale):
    ...
    if item["de"]:
        ...
        # --- D) Centavos DE (Fonte 15 | Topo 64.8mm | +0.3mm dos Reais) ---
        ...
        y_centavos_de = topo_etiqueta - (64.8 * mm * scale)
        ...
        # --- E) Risco Diagonal (Linha de 2pt com sobra de 0.5mm) ---
        ...
        y_rs_por = topo_etiqueta - (71 * mm * scale)
        ...
        y_reais_por = topo_etiqueta - (69.7 * mm * scale)
