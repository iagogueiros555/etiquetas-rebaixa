...
def desenhar_etiqueta_a4(c, item, x_base, y_base, col_w, row_h, scale):
  ...
  largura_total_de = w_de_rs + gap_de_rs + w_de_real + w_de_cent
  ...
  x_de_num = x_de_bloco_inicio + w_de_rs + gap_de_rs
  ...
  largura_total_por = w_por_rs + gap_por_rs + w_por_real + w_por_cent
  ...
  if largura_total_por > largura_quadro:
    ...
    gap_por_rs = gap_por_rs * fator_red  # O gap também reduz proporcionalmente
  ...
  x_por_num = x_por_bloco_inicio + w_por_rs + gap_por_rs
