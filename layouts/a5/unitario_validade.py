...
def desenhar_etiqueta_a5(c, item, x_base, y_base, col_w, row_h, scale):
    ...
    # --- 1. DESCRIÇÃO DO PRODUTO (mesma lógica das outras etiquetas com validade) ---
    ...
    offset_rs_unico_y = 32.0       # antes: 41.0
    offset_reais_padrao = 50.0     # antes: 59.0
    ...
    # --- 4. TARJA DE VALIDADE (CAIXA CINZA) ---
